...
<a href="https://github.com/elrouss/mesto">Изначально</a> приложение было написано на нативных технологиях: JavaScript, CSS3 и HTML5. <a href="https://github.com/elrouss/react-mesto-auth">Затем</a> проект был перенесен на "React" с добавлением функционала регистрации и авторизации пользователей, <a href="https://github.com/elrouss/express-mesto-gha">отдельно</a> написана логика серверной части с фреймворком "Express" и в завершение обе части объединены и сохранены на виртуальной машине, размещенной на <a href="https://cloud.yandex.ru/">Яндекс Облаке</a>.

<b>Адрес репозитория:</b> https://github.com/elrouss/react-mesto-api-full-gha
...
<div align="center">
  <a href="https://elrouss.mesto.nomoredomains.work">
    <img width="550" alt="Улыбающаяся Анджелина Джоли на вручении премии" src="https://user-images.githubusercontent.com/108838349/229297848-5ec3ff28-9ef2-4abf-b43c-325813ab4edf.png">
  </a>
</div>
